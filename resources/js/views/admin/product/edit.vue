...
export default {
  ...
  methods: {
    getProduct() {
      ...
      axios
        .get(`${CONSTS.API_URL}admin/product/edit/${this.id}`, {
          headers: {
        ...
        .then((res) => {
          ...
          if (res.data.success) {
            ...
            if (this.form.image) {
              this.displayPhoto = "http://127.0.0.1:8000/" + this.form.image;
    ...
    updateProduct() {
      ...
      axios
        .post(`${CONSTS.API_URL}admin/product/update/${this.id}`, this.form, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
    ...
    onFileSelected(event) {
      ...
      if (file.size > 2048770) {
        ...
        reader.onload = (event) => {
           ...
           this.displayPhoto = this.form.image;
